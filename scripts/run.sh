...
qemu-system-x86_64 \
	...
	-cpu host,hv_relaxed,hv_spinlocks=0x1fff,hv_vapic,hv_time,+vmx	`#match cpu to the one of the host, enable hyper-v enlightment for Windows guests, enable nested virtualization` \
